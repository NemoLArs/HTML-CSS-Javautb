...
$(document).ready(function()
{
    ...
    $(".projectThumbnail").on("mouseenter", function()
    {
    ...
    $(".projectThumbnail").on("mouseleave", function()
    {
    ...
    // Page navigation
    let isWorkCurrentPage = true;
    let isAboutCurrentPage = false;
...
jQuery(document).ready(function($) {
    ...
    $(".projectThumbnail").click(function() {
        ...
        let arrowNext;
        let arrowPrev;
        let arrowPrevBlocked;
        let arrowNextBlocked;
        let imgPreloaderOverlay;
        let sliderEl;
        if(isAnimating) {
            return;
        }
        ...
        if( !projectEl.data('slider-inited') ) {
            let portfolioSliderData = projectEl.find('.portfolioSliderData');
            ...
            if(portfolioSliderData.length > 0) {
                ...
                // const sliderInstance = sliderEl.portfolioSlider(sliderProps).data('portfolioSlider');
                // const numSlides = sliderInstance.numSlides;
